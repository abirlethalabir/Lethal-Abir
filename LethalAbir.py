...
os.system('clear')
psb('\x1b[1;32mBANGLADESH TETHAL ABIR 11 DIGIT CLONING START PLEASE WAIT ..........')
for n in range(9999):
...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : LETHAL ABIR'
    print 'FACEBOOK : LETHAL ABIR'
    print 'GITHUB     : github.com/abirlethalabir'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
